...
def zoomIn():
    ...
    var2=var1.pdf_view(root,pdf_location = f"./{filname}",zoomDPI=zoomDPI) # default value for zoomDPI=72. Set higher dpi for zoom in, lower dpi for zoom out
...
var2=var1.pdf_view(root,pdf_location=f"./{filname}",bar=True,load="after",zoomDPI=72)
var2.pack()
